...
public class CargoTaxiFactory extends AbstractCarFactory {
    ...
    public Car createCar(String... params) {
        ...
        CargoTaxi taxi = new CargoTaxi(spec, params[5], Double.parseDouble(params[6]), Integer.parseInt(params[7]), Integer.parseInt(params[8]), Integer.parseInt(params[9]), Integer.parseInt(params[10]), Integer.parseInt(params[11]), Service.valueOf(params[12]));
        return taxi;
    }
}
